...
export default {
  ...
  theme: {
    extend: {
       ...
       */
      colors: {
        // Primary brand color (refined indigo/purple)
        primary: {
          50: '#f8fafc',
          100: '#f1f5f9',
          200: '#e2e8f0',
        ...
        // Secondary brand color (modern blue)
        secondary: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
        ...
        // Accent color (sophisticated emerald)
        accent: {
          50: '#ecfdf5',
          100: '#d1fae5',
          200: '#a7f3d0',
